 ...
 */
class  TrackerSamplerPF : public TrackerSamplerAlgorithm//CV_EXPORTS
{
public:
 ...
 */
class  TrackerFeatureFeature2d : public TrackerFeature //CV_EXPORTS
{
 public:
 ...
 */
class  TrackerFeatureHOG : public TrackerFeature //CV_EXPORTS
{
 public:
 ...
 */
class  TrackerFeatureHAAR : public TrackerFeature //CV_EXPORTS
{
 public:
  struct  Params //V_EXPORTS
  {
    Params();
 ...
 */
class TrackerFeatureLBP : public TrackerFeature //CV_EXPORTS 
{
 public:
 ...
 */
class  TrackerMIL : public Tracker //CV_EXPORTS
{
 public:
  struct Params //CV_EXPORTS 
  {
 ...
 */
class  TrackerBoosting : public Tracker //CV_EXPORTS
{
 public:
  struct  Params//CV_EXPORTS
  {
...
reference purpose.
 */
class  TrackerMedianFlow : public Tracker//CV_EXPORTS
{
 public:
  struct Params//CV_EXPORTS 
  {
 ...
 */
class TrackerTLD : public Tracker//CV_EXPORTS 
{
 public:
  struct Params// CV_EXPORTS
  {
 ...
 */
class  TrackerKCF : public Tracker//CV_EXPORTS
{
public:
	/**
...
*/
class  MultiTracker//CV_EXPORTS_W
{
public:
	...
	*/
	MultiTracker(const String& trackerType = "");//CV_WRAP 
	...
	* @param boundingBox a rectangle represents ROI of the tracked object
	*/
	 bool add(const String& trackerType, const Mat& image, const Rect2d& boundingBox);//CV_WRAP
	...
	*/
	 bool add(const String& trackerType, const Mat& image, std::vector<Rect2d> boundingBox);//CV_WRAP
	...
	* @param boundingBox list of the tracked objects
	*/
	bool add(const Mat& image, std::vector<Rect2d> boundingBox);//CV_WRAP 
	...
	*/
	 bool update(const Mat& image, CV_OUT std::vector<Rect2d> & boundingBox);//CV_WRAP
...
Rect2d  selectROI(Mat img, bool fromCenter = true);//CV_EXPORTS_W
Rect2d selectROI(const cv::String& windowName, Mat img, bool showCrossair = true, bool fromCenter = true);//CV_EXPORTS_W 
void selectROI(const cv::String& windowName, Mat img, std::vector<Rect2d> & boundingBox, bool fromCenter = true);//CV_EXPORTS_W 
...
*/
class  MultiTracker_Alt//CV_EXPORTS
{
public:
...
*/
class MultiTrackerTLD : public MultiTracker_Alt//CV_EXPORTS 
{
public:
